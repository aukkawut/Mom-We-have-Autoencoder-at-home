#This is autoencoder from PCA and KR regression
import numpy as np
...
# Kernel regression on PCA transformed data to get the reconstruction of the intial MNIST image
kr = KernelRidge(alpha=0.3, kernel='sigmoid')
kr.fit(X_train_pca, X_train)
...
reconstructed_image = kr.predict(pca_image)
